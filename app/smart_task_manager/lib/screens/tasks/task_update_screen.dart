...
class _UpdateTaskBottomSheetState extends State<UpdateTaskBottomSheet> {
  ...
  void initState() {
    ...
    //* Initialize dropdowns and date with existing values
  ...
  Future<void> _handleSubmit() async {
    ...
    if (mounted) {
      if (success) {
        //* Double pop on success - first pop the bottom sheet, then pop the detail screen
              ...
              children: [
                ...
                Center(
                  child: OutlinedButton.icon(
                    onPressed: (_isLoadingPreview || _isUpdating)
                        ? null
                        : _loadPreview,
                ...
                //* Status Dropdown (NEW - only in update screen)
                  ...
                  child: InputDecorator(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        if (_selectedDueDate != null && !_isUpdating)
                          InkWell(
                            onTap: () {
                              setState(() {
                                _selectedDueDate = null;
